...
- Visual craft per `.opencode/skills/design-craft/SKILL.md` and `.github/skills/monstrare/ai/checklists/design-review-checklist.md`: type scale, 4px spacing grid, layered color system, one depth cue at a time, all five interactive states, and empty/loading/error coverage.
