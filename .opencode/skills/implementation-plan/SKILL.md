...
5. Decompose work into small task cards using `ai/templates/task-card.md`, output to `ai/artifacts/<Epic>/task-cards/<card-id>.md`.
6. Ensure every card meets `ai/process/definition-of-ready.md`.
