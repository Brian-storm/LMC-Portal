...
export const courseCreateSchema = z.object({
  ...
  organizerZh: z.string().optional(),
  organizerEn: z.string().optional(),
  feeDescriptionZh: z.string().optional(),
  feeDescriptionEn: z.string().optional(),
  feeDescriptionCn: z.string().optional(),
