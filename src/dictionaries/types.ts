...
export type ReceiptPageDict = Dictionary["receiptPage"]
export type AdminDict = Dictionary["admin"]
export type ErrorPageDict = Dictionary["errorPage"]
export type NotFoundPageDict = Dictionary["notFoundPage"]
export type ConfirmationDict = Dictionary["enrollPage"]["confirmation"]