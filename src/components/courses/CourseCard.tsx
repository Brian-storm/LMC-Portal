    ...
    <article className="group bg-white border border-slate-300 hover:border-primary rounded-xs shadow-2xs transition-all duration-150 relative overflow-hidden pl-1">
      ...
      <div className="p-3 sm:p-3.5 flex flex-col md:flex-row md:items-stretch justify-between gap-3">
        ...
        <div className="space-y-1.5 flex-1">
          ...
          <p className="text-slate-600 text-[10.5px] leading-normal border-l-2 border-slate-300 pl-2 py-0.5 my-1">
            {course.description}
          </p>
        ...
        {/* ------------------------------------------------------------------ */}
        <div className="flex flex-row md:flex-col items-center md:items-end justify-between border-t md:border-t-0 md:border-l border-slate-200 pt-2 md:pt-0 md:pl-3.5 min-w-[100px] shrink-0 gap-2">
