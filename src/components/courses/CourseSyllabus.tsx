  ...
  const filteredCourses = useMemo(() => {
    return initialCourses.filter((course) => {
      ...
      const matchesSearch =
        ...
        (course.iaCode && course.iaCode.toLowerCase().includes(searchLower)) ||
        (course.iaRefNumber &&
          course.iaRefNumber.toLowerCase().includes(searchLower)) ||
        (course.speaker && course.speaker.toLowerCase().includes(searchLower));
