...
export default function PageNotAModulePlaceholder() {
      ...
      <div className="max-w-md w-full bg-white border border-slate-300 p-6 shadow-2xs space-y-5 text-center border-t-4 border-t-[#1b4332]">
        ...
        <div className="space-y-2">
          ...
          <p className="text-xs text-slate-600 leading-relaxed">
            This page or course component is currently being updated to align
            with the latest IA Continuing Professional Development (CPD)
            guidelines.
          </p>
        </div>
