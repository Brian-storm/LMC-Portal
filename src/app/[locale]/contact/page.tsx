  ...
  return (
    <>
      <Breadcrumbs
        ...
        items={[{ label: dict.breadcrumbs.contact, href: "/contact" }]}
      ...
      <div className="bg-[#f6f8f6] text-slate-800 min-h-screen py-10 px-4 sm:px-6 lg:px-8 font-sans">
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-6">
            {/* Map Container */}
            <div className="md:col-span-3 bg-white border border-slate-300 shadow-2xs overflow-hidden aspect-[4/3] md:aspect-square">
              <iframe
                src={mapSrc}
                width="100%"
                height="100%"
